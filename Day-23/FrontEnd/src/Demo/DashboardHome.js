...
const DashboardHome = () => {
  useEffect(() => {
    ...
    // const buyersChart = new Chart(document.getElementById('buyers-chart'), buyersData);
    // const reviewsChart = new Chart(document.getElementById('reviews-chart'), reviewsData);
