...
function Checkout() {
  ...
  useEffect(() => {
    ...
    , getAuthorizationHeaders())
        .then(response => {
          ...
          postPaymentDeails(response.data.oid , response.data.orderTotal);
    ...
    const postPaymentDeails = (oid, amount) => { 
  ...
  //       e.preventDefault();
  //       emailjs.sendForm('service_unb0c3c', 'template_7796twi', e.target, 'bs5GyhirClfjx_O7B')
  //       .then((result) => {
  //           console.log(result);
  //       }, (error) => {
  //           console.log(error);
