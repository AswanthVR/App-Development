...
<div className="flex flex-col  items-center justify-center space-y-5  mt-4 ">
  ...
  <div className="w-full flex items-center justify-center relative py-2">
    ...
    <Link to={"/register"} > 
    <p className="text-sm font-normal text-[#060606] pb-10">Don't have an account? <span className="font-semibold underline ring-offset-2 cursor-pointer">Sign up Now</span></p></Link>
    </p>
