...
const Token = getToken('token');
  ...
  const setprofile = () => {
    ...
    return (
        <div className="dark:bg-gray-900 top-0 sticky  z-10 w-full ">
            <div>
                <div className="  bg-gray-800">
                    ...
                    {/* For md screen size */}
                    {/* For large screens */}
                    <div className="dark:bg-gray-900 bg-gray-50 px-3 py-6">
                        <div className="container mx-auto flex items-center justify-between ">
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8 ml-[-0200px]">
                                ...
                                <li>
                                <Link 
                                to={'/product/All-products'}   className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        Products
                                        </Link>
                                </li>
                                <li>
                                <Link
                  to="/aboutus"className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        About Us
                                        </Link>
                                ...
                                <li>
                                <Link
                  to="/ContactUs" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                       Contact Us
                                       </Link>
                            ...
                            <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                ...
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    <button  onClick={toggleProfile} aria-label="go to cart" className="text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
